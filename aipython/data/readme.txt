...
iris.data - the famour Iris Dataset. bezdekIris.data is a fixed version. https://archive.ics.uci.edu/ml/machine-learning-databases/iris/
...
simp_regr.csv - fictional (x,y) points for regression
simp_regr_10.csv - fictional (x,y) points for regression, like simp_regr.csv but x-values divided by 10.
