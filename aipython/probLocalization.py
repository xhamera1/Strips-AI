...
class Show_Localization(Displayable):
    ...
    def draw_dist(self):
        ...
        self.ax.set_title("Location Probability Distribution", fontsize=self.fontsize)
        self.ax.set_xticks(self.hmm.states, labels = self.hmm.states, fontsize=self.fontsize)
